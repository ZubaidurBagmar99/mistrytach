import Img from "../../../assets/images/rooftop-waterfall-designed-by-optimal-in-Greenroad-Dhanmondi.jpg"
import SideNavHome from "../../Residential/SideNavHome";

const FountainRooftopGarden = () => {
    return (
        <div className="flex">
...
export default FountainRooftopGarden;