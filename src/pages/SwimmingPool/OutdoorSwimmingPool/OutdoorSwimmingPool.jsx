import Img from "../../../assets/images/outdoor-pool-design.jpg"
import SideNavHome from "../../Residential/SideNavHome";

const OutdoorSwimmingPool = () => {
    return (
        <div className="flex">
          ...
          <div className="ml-3">
            ...
            <div>
              ...
              Outdoor Swimming Pool Builders, Suppliers & <br /> Pool Construction Company in Dhaka,<br /> Bangladesh
              </h2>
            </div>
            <div className="flex">
              <div className="w-3/5">
                <h3 className="text-2xl tracking-wider	font-semibold mb-4">
                Advantages of having an outdoor pool
                </h3>
                <p>
...
export default OutdoorSwimmingPool;