import Img from "../../../assets/images/indoor-pool-designs-residential.jpg"
import SideNavHome from "../../Residential/SideNavHome";


const IndoorSwimmingPool = () => {
    return (
        <div className="flex">
          ...
          <div className="ml-3">
            ...
            <div>
              ...
              Best Indoor Swimming Pool Builders, Suppliers & <br /> Pool Construction Company in Dhaka,<br /> Bangladesh
              </h2>
            </div>
            <div className="flex">
              <div className="w-3/5">
...
export default IndoorSwimmingPool;