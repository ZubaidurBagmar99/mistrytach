import Img from "../../../assets/images/modern-house-with-swimming-pool.jpg"
        ...
        <div className="flex">
          ...
          <div className="ml-3">
            ...
            <div>
              ...
              Modern Houses with Healthy Swimming Pool <br /> Builder, Supplier & Pool Construction Company <br /> in Dhaka.
              </h2>
            </div>
            <div className="flex">
              <div className="w-3/5">
