import Img from "../../assets/images/loft-interior-design.jpg";
    ...
    return (
      ...
      <div className="ml-3">
        ...
        <div>
          ...
          Loft Interior Design, Decoration & Consultancy Services in Dhaka, Bangladesh
          </h2>
        </div>
        <div className="flex">
          <div className="w-3/5">
