import Img from "../../../assets/images/hospital-space-interior.jpg"
import SideNavHome from "../../Residential/SideNavHome";

const HospitalSpaceInterior = () => {
    return (
        <div className="flex">
          ...
          <div className="ml-3">
            ...
            <div>
              ...
              Healthcare Architecture Design Firm in Dhaka,<br /> Bangladesh.
              </h2>
            </div>
            <div className="flex">
              <div className="w-3/5">
...
export default HospitalSpaceInterior;