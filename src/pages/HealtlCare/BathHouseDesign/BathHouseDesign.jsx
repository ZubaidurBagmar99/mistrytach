import Img from "../../../assets/images/bath-house-design-architecture.jpg"
import SideNavHome from "../../Residential/SideNavHome";

const BathHouseDesign = () => {
    return (
        <div className="flex">
          ...
          <div className="ml-3">
            ...
            <div>
              ...
              Healthcare Center Interior Design in Dhaka,<br /> Bangladesh.
              </h2>
            </div>
            <div className="flex">
              <div className="w-3/5">
...
export default BathHouseDesign;