import Img from "../../assets/images/islamic-interior-design.jpg";
import SideNavHome from "../Residential/SideNavHome";

const IslamicInterior = () => {
    return (
        <div className="flex">
      ...
      <div className="ml-3">
        ...
        <div>
          ...
          Modern creative Islamic style interior design Firm in Dhaka, Bangladesh
          </h2>
        </div>
        <div className="flex">
          <div className="w-3/5">
...
export default IslamicInterior;