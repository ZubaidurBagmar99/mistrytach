    ...
    return (
      ...
      <div className="ml-3">
        ...
        <div>
          ...
          Modern & Luxurious Villa Interior Design, Decoration & Consultancy Firm in Dhaka, Bangladesh
          </h2>
        </div>
        <div className="flex">
          <div className="w-3/5">
            ...
            <p className="mb-4">
            Villa designing is a great creative work no doubt: unlike standard apartments, it is very necessary to take into account the large structural elements, the peculiarities of the arrangement of staircases, entrance zones, terraces, fireplaces & even a view from the windows.
            </p>
            <p className="mb-4">
            Large areas allow realizing effective interior solutions in reality. It can be luxury classic villa design or modern villa design. Both options are very popular now a days.
            </p>
