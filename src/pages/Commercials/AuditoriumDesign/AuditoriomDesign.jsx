import Img from "../../../assets/images/auditorium-interior-design.jpg";
import SideNavHome from "../../Residential/SideNavHome";


const AuditoriomDesign = () => {
    return (
        <div className="flex">
          ...
          <div className="ml-3">
            ...
            <div>
              <h2 className="text-3xl font-bold mt-4 mb-4 tracking-wider">
                Corporate Office Interior Design Ideas <br /> Concepts & Consultancy
                Firm in Dhaka
              </h2>
            </div>
            <div className="flex">
...
export default AuditoriomDesign;