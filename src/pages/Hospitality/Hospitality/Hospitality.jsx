import Img from "../../../assets/images/hospitality-interior.jpg";
    ...
    <div className="flex">
      ...
      <div className="ml-3">
        ...
        <div>
          ...
          Hospitality Space Interior Designer, Contractor &
            <br /> Suppliers in Dhaka Bangladesh
          </h2>
        </div>
        <div className="flex">
          <div className="w-3/5">
            ...
            <p>
              Swimming is a major hobby and recreational sport for many
              individuals. Just like anything else, swimming pools come in all
              different types, designs, sizes, shapes and are used for various
              purposes. • Ground Pool • Architectural Pool • Family Pool:
              Recreational Swimming Pool • Infinity Pool • Indoor or Outdoor
              Pool • Kiddie Pool etc. Commonly swimming pool design refers to
              the design & creation of the different types of swimming pools and
              their accessories.
            </p>
          </div>
          <div className="w-2/5">
