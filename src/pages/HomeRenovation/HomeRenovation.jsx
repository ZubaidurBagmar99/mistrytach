import Img from "../../assets/images/renovation.jpg";
      ...
      <div className="ml-3">
        ...
        <div>
          <h2 className="text-3xl font-bold mt-4 mb-4 tracking-wider">
            Looking to Renovate Your Home into Beautiful Modern Houses? Ask
            Optimal for Your Home Renovation Works Today!
          </h2>
        </div>
        <div className="flex">
          <div className="w-3/5">
