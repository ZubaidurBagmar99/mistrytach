import Img from "../../assets/images/duplex.jpg";
    ...
    return (
      ...
      <div className="ml-3">
        <div className="bg-white shadow-lg mb-4 mt-2 rounded-md w-[870px]">
          <h3 className="text-xl py-1 ml-4  text-blue-600">Duplex House</h3>
        </div>
        <header>
          <img src={Img} alt="" />
        </header>
        <div>
          ...
          Luxury Duplex House Interior Design, Ideas, Concepts & Consultancy in Dhaka, Bangladesh
          </h2>
        </div>
        <div className="flex">
          <div className="w-3/5">
